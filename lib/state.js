...
const state = {
  submissions: [],
  countries: {
    cuba: { submissionsOpen: true, teamLocked: false, lockedAt: null, lockedTeam: [] },
    pr:   { submissionsOpen: true, teamLocked: false, lockedAt: null, lockedTeam: [] },
  },
...
function resetEverything() {
  state.submissions = [];
  state.countries.cuba = { submissionsOpen: true, teamLocked: false, lockedAt: null, lockedTeam: [] };
  state.countries.pr   = { submissionsOpen: true, teamLocked: false, lockedAt: null, lockedTeam: [] };
  state.activePhase1Card = null;
