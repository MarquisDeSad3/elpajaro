...
// Regex de votos: aceptan multiples sinonimos para que el chat pueda escribir
// natural. En modo binary (fase 1) cualquiera de los SI vale, idem NO.
// En modo duel (bracket) izq/cuba/azul/blue cuentan como 1; der/pr/rojo/red
// cuentan como 2. En octofinales el color matchea la nacionalidad
// (Cuba=azul, PR=rojo); en rondas posteriores donde hay cubano vs cubano
// o pr vs pr, los colores valen como "el de la izquierda / derecha del modal".
const SI_REGEX  = /\b(si|sí|s|yes|y|pasa|keep)\b/i;
const NO_REGEX  = /\b(no|n|fuera|kick|out)\b/i;
const ONE_REGEX = /\b(1|uno|one|izq|izquierda|left|cuba|c|a|azul|blue)\b/i;
const TWO_REGEX = /\b(2|dos|two|der|derecha|right|pr|puerto|borinquen|p|b|rojo|red)\b/i;
